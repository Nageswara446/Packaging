...
if ($null -eq $vms) {
    ...
    <body style='font-family: Arial, sans-serif; line-height: 1.5; color: #333333;'>
        ...
        If no further IAT VM is needed, feel free to disregard this notification.</p>
...
"@
            ...
            if ($tags.ExpirationDate -le $currentDateTimeFormatted) {
                ...
                $Subject2 = "Alert - IAT VM Decommissioned"
